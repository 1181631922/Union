package com.education.union.util;

import com.alibaba.fastjson.JSONObject;
import com.education.union.config.exception.CommonJsonException;
...
public class CommonUtil {
     ...
     * 查询分页结果后的封装工具方法
     *
     * @param requestJson 请求参数json，此json在之前调用fillPageParam方法时，已将pageRow放入
    ...
    private static void fillPageParam(final JSONObject paramObject, int defaultPageRow) {
        ...
        //删除此参数，防止前端穿了这个参数，pageHelper分页插件检测到之后，拦截导致SQL错误
